...
This repository is use for develop my mini project SF-yolov5 based on pretrained model yolov5s
I had forked this repository before and i can't fork this repo twice, so i'm creating this repo from scratch.
